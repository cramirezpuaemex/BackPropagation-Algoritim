...
from GuardaValorAproximar import*
import decimal
import random
import math
import tkFileDialog 
...
class ParticionesAproximar():
	...
	def main(self):
		...
		self.app = Tk()
		self.app.title('Numero de particiones para Aproximar')
		...
		# #EJECUCION
		boton = Button(self.vp, width=20, text="Ejecutar", command=self.trabajar)
