...
class ClasificarEntrenar():
	filename = ""
	pathArchivoDE=None
	def pathfile(self):
		Tk().withdraw() # we don't want a full GUI, so keep the root window from appearing
		self.filename = askopenfilename(title="Selecciona el archivo normalizado de entrenamiento para clasificar") # show an "Open" dialog box and return the path to the selected file
	...
	def main(self):
		...
		self.app = Tk()
		self.app.title('Clasificar: Entrenamiento utilizando una red neuronal')
